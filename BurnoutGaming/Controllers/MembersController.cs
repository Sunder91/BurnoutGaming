...
namespace BurnoutGaming.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MemberInfo,Name,Email,Password")] Members members)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MemberInfo,Name,Email,Password")] Members members)
        {
            if (id != members.Id)
            {
                return NotFound();
